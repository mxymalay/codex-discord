# 码驿 · CodexRelay: Windows and macOS support

The product is now named 码驿 · CodexRelay; the repository remains CodexRelay. This record retains the original branch, commit IDs and acceptance scope; repository links use the current public URL.

Status: merged into `main` through [PR #1](https://github.com/mxymalay/CodexRelay/pull/1) on 2026-09-06. Merge commit: `0453c8213e32c1ef642e2c15c3cf98d5f9478310`; final tested head: `0131f333420f952d1fcb681f88b21079ee646bd7`. Their file trees match. Use `main` for installation and updates; `codex/windows-macos-support` is the historical development branch.
